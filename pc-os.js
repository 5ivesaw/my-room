...
class PCSystem {
    ...
    renderGlyph(appId, size = '') {
        return `<span class="app-glyph glyph-${appId} ${size}" aria-hidden="true">${this.renderIconSvg(appId)}<i></i></span>`;
    }

    renderIconSvg(appId) {
        const icons = {
            files: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 7.5h6l2 2h9v7.5A2 2 0 0 1 18.5 19h-13A2 2 0 0 1 3.5 17z"/><path d="M3.5 9.5V7A2 2 0 0 1 5.5 5h4.7l1.7 1.8H18.5A2 2 0 0 1 20.5 8.8V9.5"/></svg>`,
            folder: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 8h6l1.8 2H20a1.5 1.5 0 0 1 1.5 1.5v5A2.5 2.5 0 0 1 19 19H5a2 2 0 0 1-2-2z"/><path d="M3.5 8V6.8A1.8 1.8 0 0 1 5.3 5h4l1.6 1.7H18a2 2 0 0 1 2 2V10"/></svg>`,
            browser: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8.2"/><path d="M3.8 9.2H20.2"/><path d="M3.8 14.8H20.2"/><path d="M12 3.8c2 2.2 3.1 5.1 3.1 8.2 0 3.1-1.1 6-3.1 8.2-2-2.2-3.1-5.1-3.1-8.2 0-3.1 1.1-6 3.1-8.2z"/></svg>`,
            settings: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3.1"/><path d="M19.4 15a1 1 0 0 0 .2 1.1l.1.1a1.5 1.5 0 0 1 0 2.1l-.1.1a1.5 1.5 0 0 1-2.1 0l-.1-.1a1 1 0 0 0-1.1-.2 1 1 0 0 0-.6.9V19a1.5 1.5 0 0 1-1.5 1.5h-.4A1.5 1.5 0 0 1 10.4 19v-.1a1 1 0 0 0-.6-.9 1 1 0 0 0-1.1.2l-.1.1a1.5 1.5 0 0 1-2.1 0l-.1-.1a1.5 1.5 0 0 1 0-2.1l.1-.1a1 1 0 0 0 .2-1.1 1 1 0 0 0-.9-.6H5.7A1.5 1.5 0 0 1 4.2 13v-.4a1.5 1.5 0 0 1 1.5-1.5h.1a1 1 0 0 0 .9-.6 1 1 0 0 0-.2-1.1l-.1-.1a1.5 1.5 0 0 1 0-2.1l.1-.1a1.5 1.5 0 0 1 2.1 0l.1.1a1 1 0 0 0 1.1.2 1 1 0 0 0 .6-.9V5a1.5 1.5 0 0 1 1.5-1.5h.4A1.5 1.5 0 0 1 13.8 5v.1a1 1 0 0 0 .6.9 1 1 0 0 0 1.1-.2l.1-.1a1.5 1.5 0 0 1 2.1 0l.1.1a1.5 1.5 0 0 1 0 2.1l-.1.1a1 1 0 0 0-.2 1.1 1 1 0 0 0 .9.6h.1a1.5 1.5 0 0 1 1.5 1.5v.4a1.5 1.5 0 0 1-1.5 1.5h-.1a1 1 0 0 0-.9.6z"/></svg>`,
            terminal: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="5" width="17" height="14" rx="2.5"/><path d="m8 10 2.5 2.5L8 15"/><path d="M12.8 15H16"/></svg>`,
            notepad: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4.5h8l3 3V19a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 7 19V6a1.5 1.5 0 0 1 1-1.5z"/><path d="M16 4.5V8h3"/><path d="M10 11.2h4.5"/><path d="M10 14.2h4.5"/><path d="M10 17.2h3.2"/></svg>`,
            document: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4.5h8l3 3V19a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 7 19V6A1.5 1.5 0 0 1 8.5 4.5z"/><path d="M16 4.5V8h3"/><path d="M10 12h4"/><path d="M10 15h4"/></svg>`,
            calculator: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="5.2" y="3.8" width="13.6" height="16.4" rx="2.2"/><path d="M8.2 8.2h7.6"/><path d="M8.2 12h1.8"/><path d="M12 12h1.8"/><path d="M15.8 12h0"/><path d="M8.2 15.6h1.8"/><path d="M12 15.6h1.8"/><path d="M15.8 15.6h0"/></svg>`,
            ...
            snake: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M18.5 8.5c0-1.7-1.4-3-3.1-3-1.5 0-2.8 1-3.1 2.4-.3 1.3-1.4 2.2-2.7 2.2H9a2.5 2.5 0 0 0 0 5h5.5a2.5 2.5 0 0 1 0 5H8.5"/><circle cx="16.2" cy="8.3" r=".4" fill="currentColor" stroke="none"/><circle cx="18" cy="8.3" r=".4" fill="currentColor" stroke="none"/></svg>`
        };
        return icons[appId] || `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4.5" y="4.5" width="15" height="15" rx="3"/><path d="M8.5 8.5h7"/><path d="M8.5 12h7"/><path d="M8.5 15.5h4.5"/></svg>`;
    }
